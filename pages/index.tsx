    ...
    <div>
      ...
      <main>
        <div className="flex flex-col h-vh h-vw overflow-hidden">
          <div className="relative">
            ...
            <div className="w-full relative h-[500px] md:h-[99vh]">
              <div className="absolute w-full">
                <div className="w-full h-[500px] md:min-h-[99vh] relative">
                  <Image
                    src={
                      isDesktop
          ...
          <div className="bg-[#90d4c5] h-[350px] flex flex-col justify-center items-center text-center">
            <svg
              className="text-[#2C7566] fill-current"
              width="124"
              height="24"
            ...
            <nav className="flex flex-row mx-16 my-6 justify-center">
              <div className="mx-2">
                <svg
