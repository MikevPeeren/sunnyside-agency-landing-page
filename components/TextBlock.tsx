...
const TextBlock = ({ header, content, footer, footerColor }: ITextBlock) => {
  const yellowClassNames = `${styles.footer} p-4 uppercase font-black font-fraunces after:bg-yellow after:border-bg-yellow after:bg-opacity-30`;
  const redClassNames = `${styles.footer} p-4 uppercase font-black font-fraunces after:bg-soft-red after:border-bg-soft-red after:bg-opacity-30`;
  return (
